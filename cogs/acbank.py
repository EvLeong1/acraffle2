...
class ACBANK(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        
    @commands.Cog.listener()
    async def on_ready(self):
        print("ACBANK Cog loaded!")
        
    
    @app_commands.command(name="acbank",description="Shows a list of all the shows included in ACRaffle")
    async def acbank(self,interaction: discord.Interaction, user: discord.User):
        member = user
        ...
        try:
            ...
            em = discord.Embed(title = f"{member.name.capitalize()} hasn't unlocked any characters!\nDo */acraffle* to get started then come back to see a list of all the characters and shows!",color = discord.Color.teal())
        ...
        await chl.send(f"**/acbank** - User: **{interaction.user}** - Viewed: **{member.name}** - Server: **{interaction.guild}**")
